...
class Hospital_R_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hospital_ractivity)
...
//        Log.d("List",arrayList[0].toString())
        ...
        mDbref.child("reciversHos").child("k").addValueEventListener(object :ValueEventListener{
